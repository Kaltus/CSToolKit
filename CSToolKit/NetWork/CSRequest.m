    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        if (error == nil) {
            ...
            @try {
                ...
                if ([self.delegate respondsToSelector:@selector(ordinaryRequestComplete:responseModel:)]) {
                    [self.delegate ordinaryRequestComplete:RequestDataAnalysisUnusal responseModel:responseModel];
                }
                ...
                if ([self.delegate respondsToSelector:@selector(ordinaryRequestComplete:responseModel:)]) {
                    [self.delegate ordinaryRequestComplete:RequestSuccessful responseModel:responseModel];
                }
            ...
            if ([self.delegate respondsToSelector:@selector(ordinaryRequestComplete:responseModel:)]) {
                [self.delegate ordinaryRequestComplete:RequestUnsual responseModel:responseModel];
            }
